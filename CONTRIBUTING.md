...
The Python example uses only the standard library. On macOS, use
`scripts/build-macos.sh` before manually testing a real credential; ordinary
Cargo binaries intentionally fail closed.
